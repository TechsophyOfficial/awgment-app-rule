...
public class LoggingHandler
{
    ...
    void beforeController(JoinPoint joinPoint)
    {
        ...
        logger.info(args,name,IS_INVOKED_IN_CONTROLLER);
    }
    ...
    {
        String name= joinPoint.getSignature().getName();
        logger.info(args, name, EXECUTION_IS_COMPLETED_IN_CONTROLLER);
    }
    ...
    {
        String name = joinPoint.getSignature().getName();
        logger.info(args, name, IS_INVOKED_IN_SERVICE);
    }
    ...
    {
        String name = joinPoint.getSignature().getName();
        logger.info(args, name, EXECUTION_IS_COMPLETED_IN_SERVICE);
    }
    ...
    public void logAfterThrowingController(JoinPoint joinPoint, Exception ex)
    {
        ...
        logger.error(args, CAUSE, ex.getMessage());
    }
