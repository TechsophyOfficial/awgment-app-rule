...
import static com.techsophy.tsf.rule.constants.ErrorConstants.*;
...
public class UserDetails
{
    ...
    public List<Map<String, Object>> getUserDetails() throws JsonProcessingException
    {
        ...
        {
            throw new InvalidInputException(TOKEN_NOT_NULL,globalMessageSource.get(TOKEN_NOT_NULL,token));
        }
        log.info(GATEWAY+gatewayApi);
        String userDetails = webClientWrapper.webclientRequest(webClient,gatewayApi + ACCOUNTS_URL + MANDATORY_FIELDS + FILTER_COLUMN+ loggedInUserId,GET,null);
